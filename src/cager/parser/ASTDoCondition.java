...
*/
/* Generated By:JJTree: Do not edit this line. ASTDoCondition.java */

package cager.parser;

public class ASTDoCondition extends SimpleNode {
  public ASTDoCondition(int id) {
    super(id);
  }

  public ASTDoCondition(VBParser p, int id) {
    super(p, id);
  }
  ...
  /**
 * @uml.property  name="conditionWhile"
 */
