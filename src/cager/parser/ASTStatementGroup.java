...
*/
/* Generated By:JJTree: Do not edit this line. ASTStatementGroup.java */

package cager.parser;

public class ASTStatementGroup extends SimpleNode {
  public ASTStatementGroup(int id) {
    super(id);
  }

  public ASTStatementGroup(VBParser p, int id) {
    super(p, id);
  }
