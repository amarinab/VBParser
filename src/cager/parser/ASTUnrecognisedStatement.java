...
*/
/* Generated By:JJTree: Do not edit this line. ASTUnrecognisedStatement.java */

package cager.parser;

public class ASTUnrecognisedStatement extends ASTStatement {
  public ASTUnrecognisedStatement(int id) {
    super(id);
  }

  public ASTUnrecognisedStatement(VBParser p, int id) {
    super(p, id);
  }
