...
*/
/* Generated By:JJTree: Do not edit this line. ASTVarDim.java */

package cager.parser;

public class ASTVarDim extends SimpleNode {
  public ASTVarDim(int id) {
    super(id);
  }

  public ASTVarDim(VBParser p, int id) {
    super(p, id);
  }
