...
*/
/* Generated By:JJTree: Do not edit this line. ASTCaseExpr.java */

package cager.parser;

public class ASTCaseExpr extends SimpleNode {
  public ASTCaseExpr(int id) {
    super(id);
  }

  public ASTCaseExpr(VBParser p, int id) {
    super(p, id);
  }
