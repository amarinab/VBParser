...
*/
/* Generated By:JJTree: Do not edit this line. ASTConstDeclaration.java */

package cager.parser;

public class ASTConstDeclaration extends ASTStatement {
  public ASTConstDeclaration(int id) {
    super(id);
  }

  public ASTConstDeclaration(VBParser p, int id) {
    super(p, id);
  }
