...
public class ASTTypeName extends SimpleNode {
  ...
  public ASTTypeName(VBParser p, int id) {
    super(p, id);
  }
	...
	public boolean isBaseType()
	{
		...
		String name = ((ASTName)children[0]).getName();
		...
		return
			...
			name.equalsIgnoreCase("Single") ||
			name.equalsIgnoreCase("Double") ||
			name.equalsIgnoreCase("Currency") ||
			name.equalsIgnoreCase("Decimal") ||
			name.equalsIgnoreCase("Date") ||
			name.equalsIgnoreCase("String") ||
			name.equalsIgnoreCase("Variant");
	}
