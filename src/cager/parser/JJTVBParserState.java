...
*/
/* Generated By:JJTree: Do not edit this line. JJTVBParserState.java */

package cager.parser;

class JJTVBParserState {
  /**
 * @uml.property  name="nodes"
 * @uml.associationEnd  multiplicity="(0 -1)" elementType="cager.parser.Node"
 */
...
private int sp;		// number of nodes on stack
  /**
 * @uml.property  name="mk"
 */
private int mk;		// current mark
  /**
 * @uml.property  name="node_created"
 */
