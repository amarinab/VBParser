...
*/
/* Generated By:JJTree: Do not edit this line. ASTOnError.java */

package cager.parser;

public class ASTOnError extends ASTStatement {
  public ASTOnError(int id) {
    super(id);
  }

  public ASTOnError(VBParser p, int id) {
    super(p, id);
  }
  ...
  public Object jjtAccept(VBParserVisitor visitor, Object data) {
	...
	public SimpleNode getGotoLabel()
	{
