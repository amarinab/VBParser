...
*/
/* Generated By:JJTree: Do not edit this line. ASTArgSpec.java */

package cager.parser;

public class ASTArgSpec extends SimpleNode {
  public ASTArgSpec(int id) {
    super(id);
  }

  public ASTArgSpec(VBParser p, int id) {
    super(p, id);
  }
