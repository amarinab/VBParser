...
*/
/* Generated By:JJTree: Do not edit this line. ASTFormItem.java */

package cager.parser;

public class ASTFormItem extends SimpleNode {
  public ASTFormItem(int id) {
    super(id);
  }

  public ASTFormItem(VBParser p, int id) {
    super(p, id);
  }
