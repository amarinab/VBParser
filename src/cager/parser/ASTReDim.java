...
*/
/* Generated By:JJTree: Do not edit this line. ASTReDim.java */

package cager.parser;

public class ASTReDim extends ASTStatement {
  public ASTReDim(int id) {
    super(id);
  }

  public ASTReDim(VBParser p, int id) {
    super(p, id);
  }
