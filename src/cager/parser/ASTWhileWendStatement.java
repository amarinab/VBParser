...
*/
/* Generated By:JJTree: Do not edit this line. ASTWhileWendStatement.java */

package cager.parser;

public class ASTWhileWendStatement extends ASTStatement {
  public ASTWhileWendStatement(int id) {
    super(id);
  }

  public ASTWhileWendStatement(VBParser p, int id) {
    super(p, id);
  }
