...
*/
/* Generated By:JJTree: Do not edit this line. ASTEventDeclaration.java */

package cager.parser;

public class ASTEventDeclaration extends SimpleNode {
  public ASTEventDeclaration(int id) {
    super(id);
  }

  public ASTEventDeclaration(VBParser p, int id) {
    super(p, id);
  }
